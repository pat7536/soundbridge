...
export const PHONEME_SPEECH_CONFIG = {
  // ── Short vowels ──────────────────────────────────────────────
  'short-a': { text: 'aaah',   rate: 0.35, pitch: 1.1, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-e': { text: 'ehh',    rate: 0.35, pitch: 1.0, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-i': { text: 'ih',     rate: 0.4,  pitch: 1.1, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-o': { text: 'ahh',    rate: 0.35, pitch: 0.95,volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-u': { text: 'uh',     rate: 0.35, pitch: 0.95,volume: 1.0, pauseAfter: 120, isContinuant: true  },
  ...
  'm':  { text: 'mmmm', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'n':  { text: 'nnnn', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },

  // ── Fricatives (continuants — hold-able) ─────────────────────
  's':  { text: 'sss',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'f':  { text: 'fff',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'v':  { text: 'vvv',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'h':  { text: 'hhh',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'sh': { text: 'shh',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'th-voiceless': { text: 'thh', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true },
  'th-voiced':    { text: 'the', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true },

  // ── Approximants (continuants) ────────────────────────────────
  'l':  { text: 'lll',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'r':  { text: 'rrr',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'w':  { text: 'www',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'j':  { text: 'yyy',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },

  // ── Stop consonants (brief burst — schwa minimized) ───────────
  'p':  { text: 'p',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'b':  { text: 'b',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  't':  { text: 't',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'd':  { text: 'd',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'k':  { text: 'k',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'g':  { text: 'g',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },

  // ── Affricates ────────────────────────────────────────────────
  'ch': { text: 'ch', rate: 0.6, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
