...
export const PHONEME_SPEECH_CONFIG = {
  // ── Short vowels ──────────────────────────────────────────────
  'short-a': { text: 'aaah',   ssmlIpa: 'æ',   rate: 0.35, pitch: 1.1, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-e': { text: 'ehh',    ssmlIpa: 'ɛ',   rate: 0.35, pitch: 1.0, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-i': { text: 'ih',     ssmlIpa: 'ɪ',   rate: 0.4,  pitch: 1.1, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-o': { text: 'ahh',    ssmlIpa: 'ɑ',   rate: 0.35, pitch: 0.95,volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'short-u': { text: 'uh',     ssmlIpa: 'ʌ',   rate: 0.35, pitch: 0.95,volume: 1.0, pauseAfter: 120, isContinuant: true  },

  // ── Long vowels ───────────────────────────────────────────────
  'long-a':  { text: 'ay',     ssmlIpa: 'eɪ',  rate: 0.35, pitch: 1.0, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'long-e':  { text: 'ee',     ssmlIpa: 'iː',  rate: 0.35, pitch: 1.1, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'long-i':  { text: 'aye',    ssmlIpa: 'aɪ',  rate: 0.35, pitch: 1.0, volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'long-o':  { text: 'oh',     ssmlIpa: 'oʊ',  rate: 0.35, pitch: 0.95,volume: 1.0, pauseAfter: 120, isContinuant: true  },
  'long-u':  { text: 'you',    ssmlIpa: 'juː', rate: 0.35, pitch: 1.0, volume: 1.0, pauseAfter: 120, isContinuant: true  },

  // ── Nasals (continuants — easy to isolate) ────────────────────
  'm':  { text: 'mmmm', ssmlIpa: 'm',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'n':  { text: 'nnnn', ssmlIpa: 'n',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },

  // ── Fricatives (continuants — hold-able) ─────────────────────
  's':  { text: 'sss',  ssmlIpa: 's',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'f':  { text: 'fff',  ssmlIpa: 'f',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'v':  { text: 'vvv',  ssmlIpa: 'v',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'h':  { text: 'hhh',  ssmlIpa: 'h',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'sh': { text: 'shh',  ssmlIpa: 'ʃ',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'th-voiceless': { text: 'thh', ssmlIpa: 'θ', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true },
  'th-voiced':    { text: 'the', ssmlIpa: 'ð', rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true },

  // ── Approximants (continuants) ────────────────────────────────
  'l':  { text: 'lll',  ssmlIpa: 'l',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'r':  { text: 'rrr',  ssmlIpa: 'ɹ',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'w':  { text: 'www',  ssmlIpa: 'w',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },
  'j':  { text: 'yyy',  ssmlIpa: 'j',  rate: 0.4, pitch: 1.0, volume: 1.0, pauseAfter: 100, isContinuant: true  },

  // ── Stop consonants (brief burst — schwa minimized) ───────────
  'p':  { text: 'p',  ssmlIpa: 'p',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'b':  { text: 'b',  ssmlIpa: 'b',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  't':  { text: 't',  ssmlIpa: 't',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'd':  { text: 'd',  ssmlIpa: 'd',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'k':  { text: 'k',  ssmlIpa: 'k',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
  'g':  { text: 'g',  ssmlIpa: 'ɡ',  rate: 0.8, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },

  // ── Affricates ────────────────────────────────────────────────
  'ch': { text: 'ch',  ssmlIpa: 'tʃ', rate: 0.6, pitch: 1.0, volume: 1.0, pauseAfter: 150, isContinuant: false },
...
/**
 * Returns true if the browser is Chromium-based and supports SSML
 * <phoneme> tags via the Web Speech API.
 */
function _supportsSsml() {
...
/**
 * Wraps an IPA string in an SSML <phoneme> tag so the TTS engine
 * produces the exact target sound rather than reading literal text.
 *
 * @param {string} ipaStr   – IPA phoneme characters, e.g. 's', 'ʃ', 'æ'
 * @param {string} fallback – Display text used as the tag's inner content
 */
function _buildSsmlPhoneme(ipaStr, fallback) {
  return `<speak><phoneme alphabet="ipa" ph="${ipaStr}">${fallback}</phoneme></speak>`;
}
 ...
 * @returns {Promise<void>}
 */
export function playPhoneme(phonemeId) {
  ...
  // Use SSML <phoneme alphabet="ipa"> so the TTS engine produces the
  // actual phoneme sound instead of reading the raw text literally
  // (e.g. "sss" would be spoken as "ess-ess-ess" without SSML).
  // Fall back to plain text on browsers without SSML support.
  const text = (config.ssmlIpa && _supportsSsml())
    ? _buildSsmlPhoneme(config.ssmlIpa, config.text)
    : config.text;
